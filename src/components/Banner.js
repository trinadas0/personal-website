          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <p>I'm a Computer Science major at the University of Windsor, passionate about full-stack development. My skills include <strong>Python</strong>, <strong>Java</strong>, <strong>C#</strong>, <strong>PHP</strong>, and <strong>JavaScript</strong>, which I use to build scalable applications. I also enjoy integrating machine learning into projects, like using <strong>PyTorch</strong> for image classification. When I’m not coding, I’m likely hanging out with my cat.</p>
              </div>}
            </TrackVisibility>
          </Col>
          <Col xs={12} md={6} xl={5}>
